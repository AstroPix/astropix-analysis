...
SAMPLE_READOUT_DATA = [
    ...
    bytes.fromhex('bcbce05042030620d701bcbce05041130620d701bcbcbcbcbcbcffffffffffffffffffffffffffff'),
    # Problem #1: no `bcbc` between the two events.
    bytes.fromhex('bcbce05042030620d701e05041130620d701bcbcbcbcbcbcffffffffffffffffffffffffffffffff'),
    ...
    bytes.fromhex('bcbce05042030620d701bcbce05042030620ffffffffffffffffffffffffffffffffffffffffffff'),
    bytes.fromhex('d701bcbce05041130620d701bcbcbcbcbcbcffffffffffffffffffffffffffffffffffffffffffff'),
    ...
    bytes.fromhex('bcbce05042030620e05041130620d701bcbcbcbcbcbcffffffffffffffffffffffffffffffffffff'),
    ...
    bytes.fromhex('bcbce05042e050411306bcbcbcbcbcbcffffffffffffffffffffffffffffffffffffffffffffffff'),
    # Problem #5: we have 4n `f` between the two events, and also extra `f` after
    # the second event.
    bytes.fromhex('bcbce05042030620d701bcffffffffbce05041130620d701bcbcffffbcbcbcbcffffffffffffffff')
]
